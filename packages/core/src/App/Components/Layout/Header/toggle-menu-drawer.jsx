                                ...
                                >
                                    <div className='header__menu-mobile-stack'>
                                        ...
                                        <div className='header__socials'>
                                            <a href='https://www.tiktok.com/@rugara.site?_t=ZM-90iMtuyT75Y&_r=1' target='_blank' rel='noopener noreferrer' aria-label='Facebook'>
                                            ...
                                            <a href='https://www.instagram.com/_its_rugara_?igsh=MXZjMGhtZnlwamZ6bw%3D%3D&utm_source=qr' target='_blank' rel='noopener noreferrer' aria-label='Telegram'>
                                                <Icon icon='IcTelegram' width={22} height={22} />
                                            </a>
                                            <a href='https://www.instagram.com/_its_rugara_?igsh=MXZjMGhtZnlwamZ6bw%3D%3D&utm_source=qr' target='_blank' rel='noopener noreferrer' aria-label='Instagram'>
                            ...
                            <MobileDrawer.Body className={is_traders_hub_route || is_wallet_route ? 'no-padding' : ''}>
                                ...
                                <MobileDrawer.Item>
                                    ...
                                    >
                                        ...
                                        <span className='dc-menu-link__text'>{localize('RUGARA HUB')}</span>
                                    </a>
                                </MobileDrawer.Item>
