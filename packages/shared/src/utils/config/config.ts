...
export const domain_app_ids = {
    'smarttraderstool.com': 108826,
    'deriv.app': 108826,
    'app.deriv.com': 108826,
    'staging-app.deriv.com': 108826,
    'app.deriv.me': 108826,
    'staging-app.deriv.me': 108826,
    'app.deriv.be': 108826,
    'staging-app.deriv.be': 108826,
    'binary.com': 108826,
    'test-app.deriv.com': 108826,
    'royal-app-seven.vercel.app': 108826,
    'star-eight-ruby.vercel.app': 108826,
    'beleiver.vercel.app': 108826,
    'goon-puce.vercel.app': 108826,
};
...
export const getAppId = () => {
    ...
    if (platform && platform_app_ids[platform as keyof typeof platform_app_ids]) {
        ...
        app_id = is_bot ? 108826 : domain_app_ids[current_domain as keyof typeof domain_app_ids] || 108826;
