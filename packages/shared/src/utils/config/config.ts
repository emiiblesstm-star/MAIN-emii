...
export const domain_app_ids = {
    'smarttraderstool.com': 70753,
    'deriv.app': 70753,
    'app.deriv.com': 70753,
    'staging-app.deriv.com': 70753,
    'app.deriv.me': 70753,
    'staging-app.deriv.me': 70753,
    'app.deriv.be': 70753,
    'staging-app.deriv.be': 70753,
    'binary.com': 70753,
    'test-app.deriv.com': 70753,
    'royal-app-seven.vercel.app': 70753,
    'star-eight-ruby.vercel.app': 70753,
    'beleiver.vercel.app': 70753,
    'goon-puce.vercel.app': 70753,
};
...
export const getAppId = () => {
    ...
    if (platform && platform_app_ids[platform as keyof typeof platform_app_ids]) {
        ...
        app_id = is_bot ? 70753 : domain_app_ids[current_domain as keyof typeof domain_app_ids] || 70753;
